      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="#">Home só que do lado de cá
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1 class="mt-5">Nauro's Sandbox</h1>
        <p class="lead">É só um sandbox pra mim... Se você caiu aqui por curiosidade, é um engano, não tem nada, vá embora... xô... ¯\_(ツ)_/¯</p>
      </div>
    </div>
  <div class="row">
      <div class="col-lg-12 text-center">
